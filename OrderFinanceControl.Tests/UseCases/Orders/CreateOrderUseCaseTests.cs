...
public class CreateOrderUseCaseTests
{
    ...
    public async Task ExecuteAsync_WhenCustomerAndProductsExist_ShouldCreateOrder()
    {
        ...
        var product1 = new Product("Mouse", 50.0m) { Id = "product-1" };
        var product2 = new Product("Keyboard", 100.0m) { Id = "product-2" };
    ...
    public async Task ExecuteAsync_WhenOrderCreated_ShouldCalculateTotalAmountCorrectly()
    {
        ...
        var dto = new OrderDto
        {
            ...
            Items = new List<OrderItemDto>
            {
                new() { ProductId = "product-1", Quantity = 2 }, // 50 * 2 = 100
                new() { ProductId = "product-2", Quantity = 1 }  // 100 * 1 = 100
            }
        };
